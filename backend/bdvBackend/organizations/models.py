...
class Organization(models.Model):
    ...
    office_no = models.CharField(max_length=255, verbose_name='Office Phone Number', null=True, blank=True)
    ...
    ed_no = models.CharField(max_length=255, verbose_name='Exeuctive Director Phone Number', null=True, blank=True)
